...
import (
	...
	"github.com/1055373165/ggcache/test/servicefortest/student/model"
	"github.com/1055373165/ggcache/utils/logger"
)

func migration() {
	// Import data only once the first time you create a table.
	if IsHasTable("student") {
		return
	}

	err := _db.Set("gorm:table_options", "charset=utf8mb4").AutoMigrate(&model.Student{})
	...
	InitilizeDB()
	logger.LogrusObj.Infoln("init student table data success")
}
